...
var sel="none";
var hid = ["jin","papa"];
var eventsign = "&case=<eventname>&agent=admin&amount=1";
var updateevent = "&swith=update";
//CMS functions here
...
function savelayout()
{
    ...
    var nav1 = document.getElementById("navigation_lev_1").value;
    var nav2 = document.getElementById("navigation_lev_2").value;
    var nav3 = document.getElementById("navigation_lev_3").value;
    ...
    var nms = ["logo","name","navigation_lev_1","navigation_lev_2","navigation_lev_3","phone","email","address_1","address_2"];
    var val = [logo,name,nav1,nav2,nav3,phone,email,address1,address2];
    ...
    var sign = "&" + eventsign.replace("<eventname>","maincontent");
    
    var divproject = document.getElementById("projectdiv").innerHTML;
   
    if(divproject.length>0)
    {
        var upd = "&" + eventsign.replace("<eventname>","updatecontent");
        document.location.href = pa + pt + upd + "&update=true&addfunc=true";
        
    }else
    {
        document.location.href = pa + pt + sign + "&addfunc=true";
    }
...
function gherkinlog()
{
  ...
  //  alert(path + "main?scope=city&lin=" + lin + "&pin=" + pin);
...
function showall()
{
   ...
   for(var i = 0; i<v.length; i++)
   {
    ...
    var ids = ds;
            //["BATS","BATS_LIS","XETRA","agency","principal","riskless","close_auction","market","open_auction","Limit","Market","CLOSE","Day","GTC","GTD","IOC","OPG","FOK","no","yes"];
    var tst = document.getElementById("test");
...
function newquery()
{
   ...
   // document.location.href="/corefx/start/main?scope=query&isel="+isel;
}
...
//    var b = document.getElementById("prtab@tadsetemail@main_r0c0");
//    
//    var con = b.innerHTML;
                    ...
                    if(bid.indexOf("papa")<0)
                    {
                       ...
                       if(pre === "zin")
                       {
                           if(val === "parameter" || val === "text" )
                           {
                               ...
                               if(tmp!== "-")
                               {
                                  str = str+"&sin"+bod+"="+document.getElementById("sin"+bod).value;
//                                   
                               }
                           ...
                           }else
                           {
                               if(val === "action")
                               {
                                   if(document.getElementById("sin"+bod).value)
                                   {
                                       if(document.getElementById("sin"+bod).value!=="undefined"&&document.getElementById("sin"+bod).value!=="-")
                                       {
                                           str = str+"&sin"+bod+"="+document.getElementById("sin"+bod).value;
                                       }
...
function addprojectscope()
{
    ...
    switch(sc)
    {
      ...
      document.location.href = pat+"&proscope="+scp+"&persistevent=view";          
        ...
        document.location.href = path+"main?scope=newboard&selected=main&area=&project="+scp+"&persistevent=project";    
//      var pat = cleanParam(pa,["newproject"]);
//      document.location.href = pat+"&newproject="+scp;          
            break;
        }
    }
...
function dologin()
{
    ...
    var topscope = getParamFromString(window.top.document.location.href,"scope");
    if(topscope)
    {
        if(topscope === "newpage")
        {
            
           window.top.document.location.href = path+"main?scope="+topscope+"&subscope=redpro"+"&lin="+lin+"&pin="+pin;
        }else
        {
...
function switchabout(a)
{
    switch(a)
    {
        case "about":
        {
            document.getElementById("1496074786860@main@_r0c0").style.visibility = "visible";
            document.getElementById("redwhy").style.visibility = "hidden";
            document.getElementById("about").style.background = "darkmagenta";
            document.getElementById("why").style.background = "red";
            break;
        }
                case "why":
        {
            document.getElementById("1496074786860@main@_r0c0").style.visibility = "hidden";
            document.getElementById("redwhy").style.visibility = "visible";
            document.getElementById("about").style.background = "red";
            document.getElementById("why").style.background = "darkmagenta";
...
function sendcom()
{
    ...
    var re = replaceAll(comm,"'","\\'");
    var res = replaceAll(re,"%","\\%");
    
    var pa = path + "main?scope=redgood&comment="+res+"&email="+mail+"&selected="+mail+"&case=sendcom&agent=admin&project=redpage&amount=1";
    
    if(isValidEmail(mail)&&isThing(comm))
    {
        document.location.href = pa;
    }else
    {
        alert("please make sure email and comment fields are valid!");
    }
}
...
function localize()
{
    ...
    var pro = getParam("project");
    var lan = prompt("enter language");
    window.open(path+"main?scope=localize&project="+pro+"&lan="+lan);
...
function savelocal()
{
    ...
    var id = getParam("selected");
    var lan = getParam("lan");

    var pa = path + "main?scope=terminate&selected="+id+"&val="+txt+"&lan="+lan+"&case=local&agent=admin&project=admin&amount=1";
    document.location.href = pa;
}

function openlocal(a)
{
    var lan = getParam("lan");
    var pro = getParam("project");
    window.open(path + "main?scope=local&selected="+a+"&lan="+lan+"&project="+pro,"content", "'left=20,top=20,width=1000,height=900,toolbar=1,resizable=1',scrollbars=yes,location=yes");
}

function redmail()
{
    document.location.href = "mailto:info@redhotpage.com";
}
...
function topmenu(a)
{
    ...
    switch(a)
    {
                case "contacts":
        {
            pa = path + "main?scope=redcont";
            break;
        }
        case "tech":
        {
            pa = path + "main?scope=redtech";
            break;
        }
        case "about":
        {
            pa = path + "main?scope=redabout";
            break;
        }
        case "myaccount":
        {
            pa = path + "main?scope=redpro";
            break;
        }
        case "products":
        {
...
function template()
{
    var a = prompt("please select name");
    var pa = document.location.href+"&template=true&name="+a;
    document.location.href = pa;
}
...
function gomain()
{
    //http://localhost:8080/corefx/start/main?scope=stage&selected=glogon@stage@main_r2c0&area=stage
...
function selchi(a)
{
    ...
    document.location.href = pa + "&persistevent=template";
...
function editprop(a)
{
    ...
    document.location.href = pa+"&editvalue="+newval+"&position="+va+"&persistevent=refresh";
...
function refreshglo()
{
    ...
    document.location.href = pat+"&refresh=true&persistevent=refresh";
}
...
function sendmess()
{
  ...
  var pta =  path+"main?scope=present&title="+title+"&categ="+category
    +"&mytext="+mytext;
   // alert(pta);
...
function editElement()
{
    ...
    document.location.href=path+realpar+"&persistevent=element";    
...
function submitElement()
{
  ...
  //   
    ...
    document.location.href=path + "&persistevent=element";
}
...
function selectLan(a)
{
   ...
   // document.getElementById("pone").style.background = "yellow";
...
{
    document.getElementById("trans").style.visibility = "visible";
    document.location.href = path + "main?scope=redorder&selected=" + a +"&email=" + document.getElementById("email").value;
}
...
{
    var nw = document.getElementById("new password").value;
            ...
            if(nw === cp)
    {
        if(isValid(nw))
        {
            document.location.href = path + "main?scope=redchanged&switch=update&project=redpage&email="+ml+"&event=doreset&password="+nw+"&selected="+getParamFromString(window.top.document.location.href,"id");
        }else
        {
            alert("can't contain these special chars");
        }
    }else
    {
        alert("please make sure the values match");
    }
    }else
    {
...
{
    //document.getElementById("trans").style.visibility = "visible";
    var fr = window.top.document.getElementById("bod");
    var inp = fr.contentWindow.document.getElementsByTagName("input");
...
function complogged()
{
           var lst = document.getElementById("listing").innerHTML;
           
           var listString = lst;
           
           var  comment = getParam("comment");
           var  prod = getParam("area");
         
           var email = document.getElementById("hiddenemail").innerHTML;
           var name = document.getElementById("hiddenname").innerHTML;
           
           var pa = path+"main?scope=redme&comment="+comment+"&area="+prod+"&list="+listString+"&redreg=true&case=order&agent=admin&project=redpage&amount=1&switch=insert&email="+email+"&first="+name;
...
function navigate(a)
{
    ...
    switch(a)
    {
        case "redpagereg":
        {
            ...
            var curnt = document.location.href;
            var names = ["email","first","last","phone","company","country"];
            var vals = [email,first,last,phone,company,country];
            
            pa = path + "main?scope=redmes&selected="+email;
            
            for(var i=0;i<names.length;i++)
            {
                pa = pa + "&" + names[i] + "=" + vals[i];
            }
            pa = pa + "&case=newaccount&agent=admin&project=redpage&amount=1";
        ...
        {
            pa = "";
            var ml = document.getElementById("name").value;
            if(isValidEmail(ml))
            {
               pa = path + "main?scope=redmes&selected=" + ml + "&project=redpage&event=reset&switch=update"; 
            }else
            {
        ...
        case "addcomment":
        {
            ...
            var cm = getParam("comment");
            pt = removeParam(pt,"comment",cm);
            var cleaned = replaceAll(document.getElementById("addcom").value,"'","\\'");
            if(cleaned.length<1000)
            {
                            pa = pt + "&selected=" + getParam("selected") + "&email=" + getParam("email") +"&comment=" + cleaned + "&case=addcom&agent=admin&project=redpage&amount=1";

            }else
            {
                alert("please make sure you enter <1000 chars");
                pa = document.location.href;
            }
        ...
        case "order":
        {
            ...
            var listString = getParam("extras");
            var comment = getParam("comment");
            var prod = getParam("area");          
            
            var cm = "";
            var ma = window.top.document.getElementById("myaccount").innerHTML;
            if(isThing(comment))
            {
                cm = "&comment="+comment;
            }
            if(!isThing(ma))
            {
              pa = path+"main?scope=redreg&prod="+prod+"&list="+listString+"&opt="+encodeURIComponent(document.getElementById("listing").innerHTML)+"&selected="+prod+cm;  
        ...
        case "id":
        {
            var listString = getParam("list");
            var comment = getParam("comment");
            var prod = getParam("prod");
            
            var name = document.getElementById("name").value;
            var email = document.getElementById("email").value;
            pa = path+"main?scope=redme&name="+name+"&email="+email+"&comment="+comment+"&area="+prod+"&list="+listString+"&case=registration&agent=admin&project=redpage&amount=1&switch=insert";
           // pa = "&case=newaccount&agent=admin&project=redpage&amount=1";
            if(!isThing(name))
            {
        ...
        case "redsavepro":
        {
            ...
            pa = pa + "&switch=update&event=detail&project=redpage";
...
//   if(opened)
//    {
//    var men=document.getElementById("pocusdiv");
//    var ac=document.getElementById("povinac");
//    var pov=document.getElementById("povindiv");
//        
//        
//              if(ac)
//        {
...
//    
//    var divs=[products,about,orders,signin,signup,cart];
//    
...
//         if(el.id===cur)
//        {
//        var col=el.style.background;
//         
//        if(col==="pink")
//        {
//       //after color changes and mouse moves
//       var ih=isHovered(el);
//           
//          if(_y)
//          {
...
window.popmenu=function(a)
{
 ...
 nulldetector();
  ...
  //  man.addEventListener("mouseout",onmouseout,true);
    var aps="&";
...
function expandscope(a)
{
    var pro = getParam("project");
    
    window.open("/corefx/start/main?scope=redview&project="+pro+"&area="+a);
}
...
function expanddesc(a)
{
        document.writeln("<html>");
            ...
            document.writeln("<script src='//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js\'></script>");
...
function editisel()
{
    ...
    var path="/corefx/start/EditIsel?isel="+isel+"&scheme="+schema+"&table="+table+"&col="+column+"&fields="+fiels+"&vals="
    +vals+"&colnum="+colnum+"&order="+order+"&isel2="+isel2;
...
// 
    ...
    var path="/corefx/start/table?edit="+d+"&area="+msc+"&parent="+par+realpar;
  //  
//http://localhost:8080/corefx/start/main?scope=edit&selected="+d+"&parent="+par+"&block=y&mscope="+msc
...
function createProd()
{
  ...
  var prol="winprod=true&id="+title+"&descr="+descr+"&price="+price+"&avail="+avail+"&series="+series+"&category="+category
  +"&catpres="+cat_pres+"&parent="+parent+"&pardesc="+pardes+"&title="+wid;
...
//  
   ...
   // window.open("http://localhost:8080/corefx/start/main?scope=edit&parent=main&block=y&mscope="+msc, "add", "'left=20,top=20,width=500,height=500,toolbar=1,resizable=1'");    
...
//    document.getElementById(a).style.background="rgb(255,68,34)";
...
function loadmedia()
{
    ...
    loadform.action = "/corefx/start/media?id="+id+"&cat="+ct+"&username="+us+"&gender="+gn
    +"&first="+fr+"&last="+ls+"&lan="+ln;
}
...
function escape(par,sel)
{
    ...
    //var sl=window.parent.document.getElementById("selframe"); 
    if(par)
    {
 ...
 function resizeIframe(obj) {
   ...
   if(obj.contentWindow.document.body.scrollHeight>200)
   {
        ...
        var brs = window.navigator.vendor;
      //  alert(brs);
      
      var sz = obj.contentWindow.document.body.scrollHeight;
      
      if(sz>520)
      {
          
          
             if(brs.indexOf("Google")>-1)
       {
...
//    if(isThing(obj.style.height))
//    {
//        window.document.body.scrollHeight = obj.style.height + + 50 + "px";
//    }else
//    {
//       document.getElementById("maintab").height = "200px";
//       alert(document.getElementById("maintab").height);
//    }
//    
...
function hotselect(a)
{
    ...
    sleepFor(400);
    //document.getElementById(dav).style.visibility="visible";
    if(document.getElementById("selframe"+a))
    {
    document.getElementById("selframe"+a).value="text";
...
//var pth = "/corefx/start/main?scope=status&selected="+window.top.ID+"&mscope="+window.top.lang+category;
//alert(pth);

//window.top.document.getElementById("serlab").innerHTML="/corefx/start/main?scope=status&selected="+window.top.ID+"&mscope="+window.top.lang+category;
//window.top.document.getElementById("serlab").style.color="red";
//lf.src = "/corefx/start/main?scope=status&selected="+window.top.ID+"&mscope="+window.top.lang+category;
...
//    
//    document.getElementById("meatframe").reload(true);
 //    
}
...
function submitEc()
{
    ...
    var pa = path +"main?scope=confex&first="+first+"&last="+last+"&company="+company
...
ison=false;
//var b=document.getElementById(a).style.border;
// 
};
...
function hogproceed()
{
   ...
   for(var i=0; i<st.length; i++)
   {
    ...
    if(OK)
    {
        document.location.href = path+"main?scope=hogplan&hogregister=true&finame="+fin+"&lastname="+lin+"&email="+emin+"&phone="+phonin
                +"&company="+comin;
    }
...
function proceed()
{
 ...
 var ord="/corefx/start/Reg?first="+finame+"&last="+laname+"&phone="+phone+"&email="+mail+"&town="+city+"&region="+region+"&street="+street
 +"&dom="+dom+"&appartment="+app+"&flow="+flow;
...
function golog()
{
 ...
 //   document.location.href=path+"main?scope=magazin&selected=paravoz&lin="+l+"&pin="+p;
...
function docontinue()
{
    ...
    window.top.document.getElementById("bod").src = "/corefx/start/main?scope=checkout&voiceid="
    +window.top.ID+"&volume="+window.top.vol+"&category="+window.top.cat+"&extra="+ad+"&tongue="+window.top.lang;
...
function goaccount()
{
    ...
    }else
    {
     ...
     crd.innerHTML = v+'\n'+"<div id='prfl' class='acmen' onclick='doflow(id)'>account</div>"+
            '\n'+"<div id='signout' class='acmen' onclick='signoff()'>log out</div>";    
    exp = true;
    }
...
function getExtra(a)
{
    ...
    var en = true;
    var dc = window.top.document.getElementById("redlogin").innerHTML;
    ...
    switch(a)
    {
        ...
        case "integrate":
        {
           ...
           if(en)
           {
              ...
              result = "интеграция с внешними системами"; 
           }
        ...
        case "cont":
        {
            ...
            {
                result = "система управления контентом";
            }
         ...
         case "client":
        {
            ...
            {
                result = "система управления клиентской базой";
            }
...
//          
//          var sub = getParamFromString(window.top.document.location.href,"subscope");

//          var mac = window.top.document.getElementById("myaccount").innerHTML;
//          
//          if(!isThing(sub))
//          {
//              
//              if(!isThing(mac))
//              {
//                            var pa = window.top.document.location.href + "&subscope=redpro";
//                            window.top.document.location.href = pa; 
//              }
//              
//             
//          }else
...
//          }
      ...
      if(scope === "redorder")
      {
          var torem = document.getElementById("1495375271200@main@_r0c0");
          if(torem.innerHTML === "No Item In View")
          {
              torem.style.visibility = "hidden";
          }
                //window.top.document.getElementById("bod").height = ht + +200;
        ...
        if(scope === "redreg")
      {
          ...
          var suff = "";
          var en = true;
          var nem = document.getElementById("data@redreg@main_r2c0").innerHTML;
          if(nem === "немного о вас")
          {
              en = false;
          }
          if(isThing(comment))
          {
              ...
              {
                  suff = ". Вы добавили комментарий: "+comment;
              }
                                      ...
                                      if(en)
              {
            var prods = getExtra(getParam("selected")) + " with extras: " + decodeURIComponent(getParam("opt")) + suff;
          document.getElementById("stuff").innerHTML = replaceAll(prods,"%20"," ");                
              }else
              {
            
              
          var prods = getExtra(getParam("selected")) + " с опциями: " + decodeURIComponent(getParam("opt")) + suff;;
                
              
                
                //.substring(0,getParam("list").length-1) + suff;
      ...
      if(scope === "stage")
      {
          ...
          document.getElementById("efra").src = "/corefx/start/table?edit="+getParam("selected")+
                  "&area="+area+"&parent="+parlink+"&real=true";
      }
      if(scope === "board")
      {
...
//               document.getElementById("boy").style.visibility = "hidden";             
     ...
     //     document.getElementById("extra").innerHTML = window.top.extra;
...
//            document.getElementById("maintab").clientHeight + 300+"px";
            
         //   alert(document.getElementById("maintab").style.height);
      }
      if(scope === "type")
      {
          var p = window.parent;
      ...
      if(scope === "custom")
      {
          ...
          var ar = getParam("area");
    //      document.getElementById("lefram").src = "/corefx/start/main?scope=class&selected="+sl+"&area="+ar;
      }
        ...
        if(scope==="element"||scope==="tag")
  {
      ...
      if(scope==="hotpage")
      {
        ...
        // wid=wid-30;
         ...
         document.getElementById("mainhotheadrow0col0").width="353px";
          ...
          if(bas)
          {
              var coun=bas.innerHTML;
               
              if(coun!=="0")
              {
                  bas.style.visibility="visible";
              }
             // var bl = bas.style.left;
      ...
      if(scope==="att")
      {
          var atob=document.getElementById("atfram");
          if(atob)
          {
              atob.src="/corefx/start/main?scope=upload&selected=main&mscope=main&block=y&v="+sel;
          }
...
function selectmenu(p)
{
   ...
   break;
        ...
        case "class":
        {
            ...
            //window.parent.src = "/corefx/start/main?scope=quick"+getcustom();
